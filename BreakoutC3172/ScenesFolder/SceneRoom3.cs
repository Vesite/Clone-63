...
{
    internal class SceneRoom3 : Scene
    {
        ...
        public SceneRoom3(GameManager gameManager, SceneManager sceneManager) : base(gameManager, sceneManager)
        {
        ...
        protected override void Load()
        {
            ...
            bg = Globals.Content.Load<Texture2D>("Backgrounds/bg_snow_1");
